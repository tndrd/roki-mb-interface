...
namespace Roki
{
  ...
  bool RokiRcb4Adapter::setServoPosAsync(std::vector<ServoData> &servoDatas, byte frame, byte pause)
  {
    return RokiRcb4::setServoPosAsync(servoDatas.data(), servoDatas.size(), frame, pause);
  }
