...
public:
  ...
  struct ErrorCodes {
    ...
    static constexpr Type QueueEmpty = 1;
    static constexpr Type BadSeq = 2;
    static constexpr Type UnknownMode = 3;
    static constexpr Type BadRequest = 4;

    static Type Deserialize(uint8_t error);
  };
...
private:
  ...
  template <typename T> SerialInterface::OutPackage CreatePackage(T Request);
